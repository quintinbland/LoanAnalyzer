...
print('The Future Value of the loan is',FV)

n = loan.get('remaining_months', 9)
print(n, 'months remain on the loan')
...
PV = FV / (1 + (.20/12))**n
print('The present value of this loan is', round(PV,2))
